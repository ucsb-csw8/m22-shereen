...
!['A screenshot of showing the python exe file downloading in the browser.'](https://ucsb-csw8.github.io/s22/assets/images/ide/downloading-python.png)
...
Click "Run".
!['A screenshot of showing the screen of running python installer.'](https://ucsb-csw8.github.io/s22/assets/images/ide/run-installer.png)


### Step 4. IMPORTANT! 
#### Add Python to the PATH
**IMPORTANT!** If you are on a Windows system - <span style="color:red"> make sure that the last checkbox is marked!</span>
!['A screenshot of showing the checked box to add Python to PATH.'](https://ucsb-csw8.github.io/s22/assets/images/ide/check-add-to-path.png)
...
!['A screenshot of the Python PATH.'](https://ucsb-csw8.github.io/s22/assets/images/ide/python-path.png)


### Step 5. Install

Press the “Install Now” line.
!['A screenshot of the setup progress.'](https://ucsb-csw8.github.io/s22/assets/images/ide/setup-progress.png)
...
!['A screenshot of the successful setup screen.'](https://ucsb-csw8.github.io/s22/assets/images/ide/setup-success.png)
...
!['A screenshot of the menu showing IDLE.'](https://ucsb-csw8.github.io/s22/assets/images/ide/find-menu-idle.png)
...
!['A screenshot of the menu showing how to create a new file using New File submenu.'](https://ucsb-csw8.github.io/s22/assets/images/ide/new-file.png)
...
!['A screenshot of the menu showing how to run a file using Run Module submenu.'](https://ucsb-csw8.github.io/s22/assets/images/ide/run-module.png)
...
!['A screenshot of the IDLE file that shows a help prompt.'](https://ucsb-csw8.github.io/s22/assets/images/ide/help-prompt.png)
